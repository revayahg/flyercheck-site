                    ...
                    <div className="container mx-auto px-4">
                        <div className="privacy-policy" data-name="privacy-policy">
                            ...
                            <section className="policy-section" data-name="advertising">
                                ...
                                <p>
                                    We may display ads served by Google and its partners (for example, Google AdSense). These
                                    advertising services may use cookies or similar technologies to show ads and measure ad
                                    performance.
                                </p>
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                        You can manage or opt out of personalized advertising by updating your preferences in Google's
                                        ad settings and/or using available industry opt-out tools.
                                    </li>
                                </ul>
                                <p>
